...
- `withPreferenceRetry` / `RETRY_PREFERENCE_MSGS` are preserved as deprecated re-exports; the consent-preference callers already flowed through this helper and now share the single canonical implementation.
