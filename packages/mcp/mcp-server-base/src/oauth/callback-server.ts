...
const buildAuthCallbackHtml = (message: string) => `
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    ...
    <div style="display: flex; flex-direction: column; align-items: center">
      ...
      <div style="display: flex; align-self: stretch; padding: 0 50px; justify-content: center">
        <div
          ...
          "
        >
          <h3 style="text-align: center; margin: 0; color: #5b5b74; font-size: 16px;">${message}</h3>
        </div>
      </div>
    </div>
  </body>
