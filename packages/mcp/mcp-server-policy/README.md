...
Transcend MCP Server for Policy Engine. Provides tools to author OPA Rego policies, inspect bundle versions, publish inert revisions, and explicitly set them live.
