...
Transcend MCP Server for Policy Engine (Seneca). Provides tools to author OPA Rego policies and inspect bundle versions. Publish / set-live tools land in a follow-up PR.
