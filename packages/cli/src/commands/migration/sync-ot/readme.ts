import { OneTrustPullSource } from '../../../enums.js';
import { buildExamples } from '../../../lib/docgen/buildExamples.js';
import type { SyncOtCommandFlags } from './impl.js';

const examples = buildExamples<SyncOtCommandFlags>(
  ['migration', 'sync-ot'],
  [
    {
      description: 'Syncs all assessments from the OneTrust instance to Transcend',
      flags: {
