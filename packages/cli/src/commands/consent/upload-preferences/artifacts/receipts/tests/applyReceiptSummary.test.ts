...
import type { AnyTotals, CheckModeTotals, UploadModeTotals } from '../../../ui/index.js';
import { applyReceiptSummary } from '../applyReceiptSummary.js';
...
vi.mock('../readFailingUpdatesFromReceipt.js', () => ({
...
describe('applyReceiptSummary', () => {
  beforeEach(() => {
    ...
    H.stubs.readFailingUpdatesFromReceipt.mockImplementation(() => ['f1', 'f2']);
  });
