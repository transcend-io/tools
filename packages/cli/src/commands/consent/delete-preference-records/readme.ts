...
const examples = buildExamples<DeletePreferenceRecordsCommandFlags>(
  ...
  [
    {
      description: 'Delete preference records from preference store using a CSV file',
      flags: {
    ...
    {
      description: 'Configure maximum number of concurrent API calls for a deletion file',
      flags: {
        auth: '$TRANSCEND_API_KEY',
        partition: '4d1c5daa-90b7-4d18-aa40-f86a43d2c726',
        file: './preferences-to-delete.csv',
