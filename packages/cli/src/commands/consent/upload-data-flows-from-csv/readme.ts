...
import type { UploadDataFlowsFromCsvCommandFlags } from './impl.js';

const examples = buildExamples<UploadDataFlowsFromCsvCommandFlags>(
  ['consent', 'upload-data-flows-from-csv'],
  [
    {
      description: 'Upload the file of data flows in ./data-flows.csv into the "Approved" tab',
      flags: {
    ...
    {
      description: 'Upload the file of data flows in ./data-flows.csv into the "Triage" tab',
      flags: {
        auth: '$TRANSCEND_API_KEY',
