...
import type { UploadCookiesFromCsvCommandFlags } from './impl.js';

const examples = buildExamples<UploadCookiesFromCsvCommandFlags>(
  ['consent', 'upload-cookies-from-csv'],
  [
    {
      description: 'Upload the file of cookies in ./cookies.csv into the "Approved" tab',
      flags: {
    ...
    {
      description: 'Upload the file of cookies in ./cookies.csv into the "Triage" tab',
      flags: {
        auth: '$TRANSCEND_API_KEY',
