...
import { arrayParser } from '../../../lib/cli/parsers.js';

export const buildXdiSyncEndpointCommand = buildCommand({
  loader: async () => {
    const { buildXdiSyncEndpoint } = await import('./impl.js');
  ...
  parameters: {
    flags: {
      ...
      xdiLocation: {
        kind: 'parsed',
        parse: String,
        brief: 'The location of the XDI that will be loaded by the generated sync endpoint',
      },
      file: {
        kind: 'parsed',
        parse: String,
