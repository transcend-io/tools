import { ConsentTrackerStatus, ScopeName, TRANSCEND_SCOPES } from '@transcend-io/privacy-types';

import { TR_PULL_RESOURCE_SCOPE_MAP } from '../../../constants.js';
...
import type { PullCommandFlags } from './impl.js';
...
const examples = buildExamples<PullCommandFlags>(
  ...
  [
    ...
    },
    {
      ...
      flags: {
        auth: '$TRANSCEND_API_KEY',
        resources: [TranscendPullResource.DataFlows, TranscendPullResource.Cookies],
        trackerStatuses: [ConsentTrackerStatus.NeedsReview, ConsentTrackerStatus.Live],
      },
    },
    {
    ...
    {
      description: 'Pull onboarding action items (see [this example](./examples/action-items.yml))',
      flags: {
        auth: '$TRANSCEND_API_KEY',
        resources: [TranscendPullResource.ActionItems, TranscendPullResource.ActionItemCollections],
      },
    },
    {
      description:
    ...
    },
    {
      ...
      flags: {
        auth: '$TRANSCEND_API_KEY',
        resources: [TranscendPullResource.PrivacyCenters, TranscendPullResource.Messages],
      },
    },
    {
      ...
      flags: {
        auth: '$TRANSCEND_API_KEY',
        resources: [TranscendPullResource.Assessments, TranscendPullResource.AssessmentTemplates],
      },
    },
    {
