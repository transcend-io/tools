...
import type { NotifyAdditionalTimeCommandFlags } from './impl.js';
...
const examples = buildExamples<NotifyAdditionalTimeCommandFlags>(
  ...
  [
    ...
    {
      description: 'Notify all request types that were made during a date range',
      flags: {
        auth: '$TRANSCEND_API_KEY',
        createdAtBefore: getExampleDate('01/01/2024'),
    ...
    {
      description: 'Only notify requests that are expiring in the next 3 days or less',
      flags: {
        auth: '$TRANSCEND_API_KEY',
        createdAtBefore: getExampleDate('01/01/2024'),
        daysLeft: 3,
    ...
    {
      description: 'Send a specific email template to the request that instead of the default',
      flags: {
        auth: '$TRANSCEND_API_KEY',
        createdAtBefore: getExampleDate('01/01/2024'),
