...
const examples = buildExamples<PushIdentifiersCommandFlags>(
  ...
  [
    {
      description: 'Push up a set of identifiers for a set of requests pending manual enrichment',
      flags: {
    ...
    {
      description: 'When enriching requests, mark all requests as silent mode before processing',
      flags: {
        auth: '$TRANSCEND_API_KEY',
        enricherId: '27d45a0d-7d03-47fa-9b30-6d697005cfcf',
        markSilent: true,
