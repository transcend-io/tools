...
import type { PushIdentifiersCommandFlags } from '../push-identifiers/impl.js';
import type { PullIdentifiersCommandFlags } from './impl.js';

export const pullIdentifiersCommand = buildCommand({
  loader: async () => {
    const { pullIdentifiers } = await import('./impl.js');
