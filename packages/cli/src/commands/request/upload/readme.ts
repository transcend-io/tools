...
import type { UploadCommandFlags } from './impl.js';
...
const examples = buildExamples<UploadCommandFlags>(
  ...
  [
    ...
    {
      description: 'Send email communications to the users throughout the request lifecycle',
      flags: {
        auth: '$TRANSCEND_API_KEY',
        file: '/Users/transcend/Desktop/test.csv',
        isSilent: false,
    ...
    {
      description: 'Tag all uploaded requests with custom fields (formerly known as "attributes")',
      flags: {
        auth: '$TRANSCEND_API_KEY',
        file: '/Users/transcend/Desktop/test.csv',
