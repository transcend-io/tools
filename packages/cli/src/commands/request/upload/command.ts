...
export const uploadCommand = buildCommand({
  ...
  parameters: {
    flags: {
      ...
      isTest: {
        kind: 'boolean',
        brief: 'Flag whether the requests being uploaded are test requests or regular requests',
        default: false,
      },
      isSilent: {
        kind: 'boolean',
        brief: 'Flag whether the requests being uploaded should be submitted in silent mode',
        default: true,
      },
      skipSendingReceipt: {
        kind: 'boolean',
