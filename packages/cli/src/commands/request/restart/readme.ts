...
import type { RestartCommandFlags } from './impl.js';
...
const examples = buildExamples<RestartCommandFlags>(
  ...
  [
    ...
    {
      description: 'Restart requests that were submitted before a specific date',
      flags: {
        auth: '$TRANSCEND_API_KEY',
        statuses: [RequestStatus.Compiling, RequestStatus.Enriching],
        actions: [RequestAction.Access, RequestAction.Erasure],
    ...
    {
      description: 'Copy over all enriched identifiers from the initial request',
      flags: {
        auth: '$TRANSCEND_API_KEY',
        statuses: [RequestStatus.Compiling, RequestStatus.Enriching],
        actions: [RequestAction.Access, RequestAction.Erasure],
