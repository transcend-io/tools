...
> = {
  ...
  [TranscendPullResource.Attributes]: {
    ...
    markdownLinks: ['[Custom Fields](https://app.transcend.io/infrastructure/attributes)'],
  },
...
(https://app.transcend.io/consent-manager/developer-settings/advanced-settings)',
  ...
  [TranscendPullResource.ActionItems]: {
    ...
    markdownLinks: ['[Action Items](https://app.transcend.io/action-items/all)'],
  },
  ...
  [TranscendPullResource.Teams]: {
    ...
    markdownLinks: ['[Administration -> Teams](https://app.transcend.io/admin/teams)'],
  },
  [TranscendPullResource.PrivacyCenters]: {
    description: 'The Privacy Center settings.',
    markdownLinks: ['[Privacy Center](https://app.transcend.io/privacy-center/general-settings)'],
  },
...
(https://app.transcend.io/consent-manager/display-settings/messages)',
  ...
  [TranscendPullResource.Assessments]: {
    ...
    markdownLinks: ['[Assessments -> Assessments](https://app.transcend.io/assessments/groups)'],
  },
