...
const expected: CodePackageInput[] = [
  ...
  },
  {
    ...
    relativePath: 'test-package-json/test-nested-requirements-txt/requirements.txt',
    repositoryName: 'transcend-io/cli',
  },
  {
    name: 'test-gemfile',
  ...
  },
  {
    ...
    relativePath: 'test-swift/transcend.xcworkspace/xcshareddata/swiftpm/Package.resolved',
    repositoryName: 'transcend-io/cli',
    softwareDevelopmentKits: [
      {
        name: 'alamofire',
 ...
 */
function sortCodePackages(codePackages: CodePackageInput[]): CodePackageInput[] {
  return codePackages
