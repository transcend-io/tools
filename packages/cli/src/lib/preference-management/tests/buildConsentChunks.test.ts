...
describe('buildConsentChunks', () => {
  ...
  it(
    ...
    () => {
      ...
      expect(tsRange(chunks[0])).toEqual(['2025-01-01T10:15:00.000Z', '2025-01-01T12:14:59.999Z']);
      expect(tsRange(chunks[1])).toEqual(['2025-01-01T12:15:00.000Z', '2025-01-01T14:14:59.999Z']);
      expect(tsRange(chunks[2])).toEqual(['2025-01-01T14:15:00.000Z', '2025-01-01T16:14:59.999Z']);
    },
  );
  ...
  it('enforces a minimum chunk span of 5 minutes for tiny windows (timestamp mode)', () => {
    ...
    expect(chunks).toHaveLength(3);
    expect(tsRange(chunks[0])).toEqual(['2025-01-01T10:05:00.000Z', '2025-01-01T10:09:59.999Z']);
    expect(tsRange(chunks[1])).toEqual(['2025-01-01T10:10:00.000Z', '2025-01-01T10:14:59.999Z']);
    expect(tsRange(chunks[2])).toEqual(['2025-01-01T10:15:00.000Z', '2025-01-01T10:19:59.999Z']);
  });
  ...
  it('produces system.updated* fields with fixed steps and a short tail (updated mode)', () => {
    ...
    expect(updRange(chunks[0])).toEqual(['2025-02-01T01:20:00.000Z', '2025-02-01T02:19:59.999Z']);
    expect(updRange(chunks[1])).toEqual(['2025-02-01T02:20:00.000Z', '2025-02-01T03:19:59.999Z']);
    expect(updRange(chunks[2])).toEqual(['2025-02-01T03:20:00.000Z', '2025-02-01T04:19:59.999Z']);
    expect(updRange(chunks[3])).toEqual(['2025-02-01T04:20:00.000Z', '2025-02-01T05:19:59.999Z']);
    expect(updRange(chunks[4])).toEqual(['2025-02-01T05:20:00.000Z', '2025-02-01T05:23:44.999Z']);
  });
  ...
  it('caps the number of chunks by increasing chunk size when maxChunks is small', () => {
    ...
    expect(tsRange(chunks[0])).toEqual(['2025-03-10T00:00:00.000Z', '2025-03-10T04:59:59.999Z']);
    expect(tsRange(chunks[1])).toEqual(['2025-03-10T05:00:00.000Z', '2025-03-10T09:59:59.999Z']);
  });
});
