...
| `workflowConfigs`           | `workflow-configs`            | DSR workflow config settings.                                                                                                                                                            | Manage Workflows, View Data Subject Request Settings, View Global Attributes                                                | [Workflows -> DSR Workflows](https://app.transcend.io/privacy-requests/workflows)                                                                                                                                                                      |
