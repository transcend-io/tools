...
| `workflowConfigs`       | `workflow-configs`        | Workflow config settings (update-only — workflow configs are created in the Admin Dashboard).                                                                    | View Data Subject Request Settings                   | [Workflows -> DSR Workflows](https://app.transcend.io/privacy-requests/workflows)                                                                                                                                                                      |
