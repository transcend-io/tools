...
| `consentWorkflowTriggers` | `consent-workflow-triggers` | Consent workflow trigger definitions (Preferences → Consent Workflows). Purposes drive trigger conditions.                                                       | View Preference Store Settings                       | [Preferences -> Consent Workflows](https://app.transcend.io/preference-store/consent-workflows)                                                                                                                                                        |
...
| `consentWorkflowTriggers` | `consent-workflow-triggers` | Consent workflow trigger definitions (Preferences → Consent Workflows). Purposes drive trigger conditions.                                                       | Manage Preference Store Settings, View Data Subject Request Settings, View Consent Manager, View Data Map | [Preferences -> Consent Workflows](https://app.transcend.io/preference-store/consent-workflows)                                                                                                                                                        |
