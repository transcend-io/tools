...
| `consentWorkflowTriggers` | `consent-workflow-triggers` | Consent workflow trigger definitions (Workflows → Preference Workflows). Purposes drive trigger conditions.                                                      | View Preference Store Settings                       | [Workflows -> Preference Workflows](https://app.transcend.io/preference-store/consent-workflows)                                                                                                                                                       |
...
| `consentWorkflowTriggers` | `consent-workflow-triggers` | Consent workflow trigger definitions (Workflows → Preference Workflows). Purposes drive trigger conditions.                                                      | Manage Preference Store Settings, View Data Subject Request Settings, View Consent Manager, View Data Map | [Workflows -> Preference Workflows](https://app.transcend.io/preference-store/consent-workflows)                                                                                                                                                       |
