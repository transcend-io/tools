...
| `workflowConfigs`       | `workflow-configs`        | DSR workflow config settings (update-only — workflow configs are created in the Admin Dashboard).                                                                | View Data Subject Request Settings                   | [Workflows -> DSR Automation](https://app.transcend.io/privacy-requests/workflows)                                                                                                                                                                     |
...
| `workflowConfigs`       | `workflow-configs`        | DSR workflow config settings (update-only — workflow configs are created in the Admin Dashboard).                                                                | Manage Workflows                                         | [Workflows -> DSR Workflows](https://app.transcend.io/privacy-requests/workflows)                                                                                                                                                                      |
