...
| `workflowConfigs`       | `workflow-configs`        | Workflow config settings (update-only — workflow configs are created in the Admin Dashboard).                                                                    | Manage Workflows, View Data Subject Request Settings, View Global Attributes | [Workflows -> DSR Workflows](https://app.transcend.io/privacy-requests/workflows)                                                                                                                                                                      |
