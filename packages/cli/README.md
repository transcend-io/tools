...
```sh
transcend inventory scan-packages --auth="$TRANSCEND_API_KEY" --scanPath=./packages/mobile-app/
```
...
**Scan multiple file types (Podfile, Gradle, etc.) in a mobile app repository**
