...
| `workflowConfigs`       | `workflow-configs`        | Workflow config settings (update-only — workflow configs are created in the Admin Dashboard).                                                                    | View Workflows                                       | [Workflows -> DSR Workflows](https://app.transcend.io/privacy-requests/workflows)                                                                                                                                                                      |
...
| `workflowConfigs`       | `workflow-configs`        | Workflow config settings (update-only — workflow configs are created in the Admin Dashboard).                                                                    | Manage Workflows                                         | [Workflows -> DSR Workflows](https://app.transcend.io/privacy-requests/workflows)                                                                                                                                                                      |
