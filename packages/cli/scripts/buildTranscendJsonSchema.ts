 ...
 * `# yaml-language-server: $schema=https://raw.githubusercontent.com/transcend-io/developer-tools/main/packages/cli/transcend-yml-schema-latest.json`
 *
...
[`v${majorVersion}`, 'latest'].forEach((key) => {
  ...
  const schemaFilePath = join(packageRoot, fileName);
